...
//set off, go straight, exceed speed limit
        ...
        .from("#speed-notif", {duration: 1, alpha: 0, x: "+=300", ease: "power4.out"}, "-=.58")
        .to("#arrow-icon", {duration: 5.5, y: "-=258.5", ease: "power2.out"}, "-=1")

//turn left, pop up window, slow down, stop
        .to("#arrow-icon", {duration: 1, rotate: -90, ease: "none"}, "-=2.2")
